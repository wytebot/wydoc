import {initializeApp} from 'firebase/app';import {getAuth,GoogleAuthProvider,signInWithPopup,signOut,onAuthStateChanged} from 'firebase/auth';
...
if(Object.values(cfg).some(v=>!v))throw new Error('WyDoc Firebase configuration is missing. Add the VITE_FIREBASE_* environment variables.');
